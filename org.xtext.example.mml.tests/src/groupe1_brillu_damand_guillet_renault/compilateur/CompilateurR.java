...
public class CompilateurR {
	...
	private String traitementSVM() {
		...
		String algoSet = "svm_model <- svm(" + predVar
				+ " ~ ., data=train_set, kernel=\"radial\", cost=1, gamma=0.5) \n";
